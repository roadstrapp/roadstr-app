...
class AppLocalizationsSv extends AppLocalizations {
  ...
  @override
  String get favoritesAutoSyncTitle => 'Synkronisera automatiskt';

  @override
  String get favoritesAutoSyncDesc =>
      'Publicerar varje ändring direkt och hämtar den vid start, utan att behöva knapparna nedan. Avstängt som standard: vad reläer ändå kan se trots krypteringen förklaras ovan.';
  ...
  @override
  String get avoidUnpavedRoads => 'Undvik grusvägar';

  @override
  String get avoidUnpavedRoadsDescription =>
      'Styr rutten bort från grusvägar och skogsbilvägar när ett asfalterat alternativ finns. Det är en preferens, inte en garanti: kartdata om vägbeläggning är ofullständig, så bedöm alltid själv vägens skick innan du kör på den.';
  ...
  @override
  String get nearbyRestaurant => 'Restaurang';
