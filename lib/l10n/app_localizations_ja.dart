...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String get kokoroModelSupportedLangs =>
      '対応言語：イタリア語、英語、スペイン語、フランス語、日本語、中国語、ポルトガル語、ドイツ語';
  ...
  @override
  String get kokoroVolumeTitle => '音声の音量';
  ...
  @override
  String get avoidUnpavedRoads => '未舗装路を回避';

  @override
  String get avoidUnpavedRoadsDescription =>
      '舗装された代替ルートがある場合、砂利道やダート路を避けるようルートを誘導します。これは保証ではなく設定上の希望です。路面に関する地図データは不完全なため、走行前には必ず自分の目で道路の状態を確認してください。';
