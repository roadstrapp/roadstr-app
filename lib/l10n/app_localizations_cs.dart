...
class AppLocalizationsCs extends AppLocalizations {
  ...
  @override
  String get cursorColorYellow => 'Žlutá';
  ...
  String get kokoroModelSupportedLangs =>
      'Podporuje: italštinu, angličtinu, španělštinu, francouzštinu, japonštinu, čínštinu, portugalštinu, němčinu';
  ...
  @override
  String get kokoroVolumeTitle => 'Hlasitost hlasu';
  ...
  @override
  String get parkingLongPressConfirm => 'Nastavit toto místo jako parkování?';
  ...
  @override
  String get favoritesAutoSyncTitle => 'Synchronizovat automaticky';

  @override
  String get favoritesAutoSyncDesc =>
      'Okamžitě publikuje každou změnu a při spuštění ji stáhne, bez nutnosti používat tlačítka níže. Ve výchozím nastavení vypnuto: co mohou relaye i přes šifrování stále vidět, je vysvětleno výše.';
  ...
  @override
  String get syncCustomRelayTitle => 'Vlastní relay (volitelné)';

  @override
  String get syncCustomRelayDesc =>
      'Přidejte relay, který provozujete nebo platíte, a oblíbená místa se budou publikovat i tam. Veřejné relaye nic neslibují o tom, jak dlouho data uchovávají; ten váš ano. Ponechte prázdné pro použití pouze vestavěných relayů.';

  @override
  String get syncCustomRelayInvalid =>
      'Neplatná adresa relaye. Musí začínat wss://';
  ...
  @override
  String get avoidUnpavedRoads => 'Vyhýbat se nezpevněným cestám';

  @override
  String get avoidUnpavedRoadsDescription =>
      'Nasměruje trasu mimo polní cesty a nezpevněné povrchy, pokud existuje zpevněná alternativa. Jde o preferenci, ne záruku: mapová data o povrchu vozovky jsou neúplná, proto si stav cesty vždy posuďte sami před jízdou.';
  ...
  String ztlNearRouteWarning(String street) {
    return 'Pozor: $street je zóna s omezeným provozem';
  }

  @override
  String get themeModernNostr => 'Moderní · Nostr fialová';

  @override
  String get themeModernBitcoin => 'Moderní · Bitcoin oranžová';

  @override
  String get themeModernDarkNostr => 'Moderní tmavý · Nostr fialová';

  @override
  String get themeModernDarkBitcoin => 'Moderní tmavý · Bitcoin oranžová';

  @override
  String get plannerAddStop => 'Přidat zastávku';

  @override
  String get plannerStopHint => 'Zastávka po cestě';

  @override
  String get plannerStopsFull => 'Další zastávky nelze přidat';

  @override
  String plannerStopAdded(String place) {
    return 'Zastávka přidána: $place';
  }
}
