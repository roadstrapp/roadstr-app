...
class AppLocalizationsEl extends AppLocalizations {
  ...
  @override
  String get cursorColorViolet => 'Μωβ';

  @override
  String get cursorColorIndigo => 'Λουλακί';

  @override
  String get cursorColorBlue => 'Μπλε';

  @override
  String get cursorColorGreen => 'Πράσινο';

  @override
  String get cursorColorYellow => 'Κίτρινο';

  @override
  String get cursorColorOrange => 'Πορτοκαλί';

  @override
  String get cursorColorRed => 'Κόκκινο';
  ...
  String thenManeuver(String instruction) {
    return 'στη συνέχεια $instruction';
  }
  ...
  String get wikipediaLoadFailed =>
      'Η Wikipedia δεν μπόρεσε να φορτωθεί με ασφάλεια.';

  @override
  String get retry => 'Δοκιμή ξανά';

  @override
  String get poiDetailsFromOsm => 'Πληροφορίες από το OpenStreetMap';

  @override
  String get poiCategory => 'Κατηγορία';

  @override
  String get poiOperator => 'Διαχειριστής';
  ...
  String get poiWheelchairLimited =>
      'Περιορισμένη πρόσβαση με αναπηρικό αμαξίδιο';

  @override
  String get poiWheelchairNo => 'Μη προσβάσιμο με αναπηρικό αμαξίδιο';

  @override
  String get poiContact => 'Επικοινωνία';

  @override
  String get poiAddress => 'Διεύθυνση';
  ...
  @override
  String get poiOpenNow => 'Ανοιχτά τώρα';

  @override
  String get poiClosedNow => 'Κλειστά';
  ...
  @override
  String get kokoroVolumeTitle => 'Ένταση φωνής';
  ...
  @override
  String get favoritesAutoSyncTitle => 'Αυτόματος συγχρονισμός';

  @override
  String get favoritesAutoSyncDesc =>
      'Δημοσιεύει κάθε αλλαγή αμέσως και την κατεβάζει κατά την εκκίνηση, χωρίς να χρειάζονται τα παρακάτω κουμπιά. Απενεργοποιημένο από προεπιλογή: τι μπορούν να δουν οι αναμεταδότες παρά την κρυπτογράφηση εξηγείται παραπάνω.';
  ...
  @override
  String get syncCustomRelayTitle => 'Δικός σας αναμεταδότης (προαιρετικό)';

  @override
  String get syncCustomRelayDesc =>
      'Προσθέστε έναν αναμεταδότη που διαχειρίζεστε ή πληρώνετε και τα αγαπημένα σας θα δημοσιεύονται και εκεί. Οι δημόσιοι αναμεταδότες δεν υπόσχονται τίποτα για το πόσο κρατούν τα δεδομένα· ο δικός σας ναι. Αφήστε το κενό για να χρησιμοποιηθούν μόνο οι ενσωματωμένοι.';

  @override
  String get syncCustomRelayInvalid =>
      'Μη έγκυρη διεύθυνση αναμεταδότη. Πρέπει να ξεκινά με wss://';
  ...
  @override
  String get avoidUnpavedRoads => 'Αποφυγή χωματόδρομων';

  @override
  String get avoidUnpavedRoadsDescription =>
      'Κατευθύνει τις διαδρομές μακριά από χωματόδρομους και ανώμαλους δρόμους, όταν υπάρχει ασφαλτοστρωμένη εναλλακτική. Είναι προτίμηση, όχι εγγύηση: τα δεδομένα χάρτη για την επιφάνεια του δρόμου είναι ελλιπή, γι\' αυτό να κρίνεις πάντα μόνος/η την κατάσταση ενός δρόμου πριν τον οδηγήσεις.';
  ...
  String ztlNearRouteWarning(String street) {
    return 'Προσοχή: $street είναι ζώνη περιορισμένης κυκλοφορίας';
  }

  @override
  String get themeModernNostr => 'Μοντέρνο · Μωβ Nostr';

  @override
  String get themeModernBitcoin => 'Μοντέρνο · Πορτοκαλί Bitcoin';

  @override
  String get themeModernDarkNostr => 'Μοντέρνο σκούρο · Μωβ Nostr';
