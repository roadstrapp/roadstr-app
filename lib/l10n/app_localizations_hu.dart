...
class AppLocalizationsHu extends AppLocalizations {
  ...
  @override
  String get avoidUnpavedRoads => 'Földutak elkerülése';

  @override
  String get avoidUnpavedRoadsDescription =>
      'Aszfaltozott alternatíva esetén elkerüli a földutakat és a rossz minőségű utakat. Ez preferencia, nem garancia: az útburkolatra vonatkozó térképadatok hiányosak, ezért mindig magad ítéld meg az út állapotát vezetés előtt.';
