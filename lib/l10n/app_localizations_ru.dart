...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get syncCustomRelayTitle => 'Свой релей (необязательно)';

  @override
  String get syncCustomRelayDesc =>
      'Добавьте релей, который вы держите или оплачиваете, — избранное будет публиковаться и туда. Публичные релеи ничего не обещают о сроках хранения данных, а ваш обещает. Оставьте пустым, чтобы использовать только встроенные релеи.';

  @override
  String get syncCustomRelayInvalid =>
      'Неверный адрес релея. Он должен начинаться с wss://';
  ...
  @override
  String get avoidUnpavedRoads => 'Избегать грунтовых дорог';

  @override
  String get avoidUnpavedRoadsDescription =>
      'Направляет маршрут в обход грунтовых и просёлочных дорог, если существует асфальтированная альтернатива. Это предпочтение, а не гарантия: картографические данные о покрытии дорог неполны, поэтому всегда самостоятельно оценивайте состояние дороги перед тем, как по ней ехать.';
  ...
  String ztlNearRouteWarning(String street) {
    return 'Внимание: $street — зона ограниченного движения';
  }

  @override
  String get themeModernNostr => 'Современная · Фиолетовый Nostr';

  @override
  String get themeModernBitcoin => 'Современная · Оранжевый Bitcoin';

  @override
  String get themeModernDarkNostr => 'Современная тёмная · Фиолетовый Nostr';
