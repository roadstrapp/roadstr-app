...
public class GeolocationManager
  ...
  public LocationClient createLocationClient(
    ...
    // Roadstr fork: always the AOSP LocationManager. Upstream picks the Google
    // Play Services "fused" client when it is available; that client, and the
    // proprietary library behind it, are removed here. The app already passed
    // forceAndroidLocationManager on every call, so behaviour is unchanged --
    // what changes is that the unused branch no longer ships in the APK.
